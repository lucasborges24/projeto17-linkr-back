...
ALTER TABLE "posts" ADD CONSTRAINT "posts_fk0" FOREIGN KEY ("writerId") REFERENCES "users"("id");
...
ALTER TABLE "likesPosts" ADD CONSTRAINT "likesPosts_fk0" FOREIGN KEY ("postId") REFERENCES "posts"("id");
ALTER TABLE "likesPosts" ADD CONSTRAINT "likesPosts_fk1" FOREIGN KEY ("userId") REFERENCES "users"("id");
